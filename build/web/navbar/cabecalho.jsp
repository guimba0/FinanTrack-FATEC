...
<%
    ...
    if (session.getAttribute("usuarioLogado") != null) {
        ...
        // Prevenção de erro caso o ID não esteja na sessão
        if(usuarioId != null) {
            try {
                ...
                e.printStackTrace(); // Evita que erro no banco quebre o cabeçalho inteiro
            }
        }
    }
%>
...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary mb-4 shadow-sm">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold" href="${pageContext.request.contextPath}/dashboard/dashboard.jsp">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <% if (session.getAttribute("usuarioLogado") != null) { %>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/dashboard/detalhes_mes.jsp">Lançamentos</a>
                        </li>
                        <li class="nav-item">
                ...
                <ul class="navbar-nav ms-auto">
                    <% if (session.getAttribute("usuarioLogado") != null) { %>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <% } else { %>
                                    ...
                                    <% for (String notificacao : notificacoes) { %>
                                        <li><a class="dropdown-item small" href="${pageContext.request.contextPath}/dashboard/detalhes_mes.jsp"><i class="bi bi-exclamation-circle text-warning"></i> <%= notificacao %></a></li>
                                    <% } %>
                                <% } %>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="${pageContext.request.contextPath}/navbar/dados_usuario.jsp">Meus Dados</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item text-danger" href="${pageContext.request.contextPath}/LogoutServlet">Sair</a></li>
                            </ul>
                        </li>
                    <% } else { %>
                        <li class="nav-item">
