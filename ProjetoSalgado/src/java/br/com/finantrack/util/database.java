...
public class database {
    ...
    public static void init(String webInfPath) {
        try {
            ...
            // Lógica para encontrar o caminho do banco de dados
            ...
            try (Connection conn = getConnection(); Statement stmt = conn.createStatement()) {
                ...
                // --- Tabela de contas recorrentes CORRIGIDA ---
                // Adicionada a coluna "dia_vencimento"
                stmt.execute("CREATE TABLE IF NOT EXISTS contas_recorrentes (" +
                             ...
                             "valor REAL NOT NULL," +
                             "categoria TEXT NOT NULL," +
                             "dia_vencimento INTEGER," + // Pode ser nulo
                             "data_inicio TEXT NOT NULL," +
                             "data_fim TEXT," + // Pode ser nulo
                             "FOREIGN KEY (usuario_id) REFERENCES usuarios(id));");
            }
