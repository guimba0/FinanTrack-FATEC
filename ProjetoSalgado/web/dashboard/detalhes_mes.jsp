                    ...
                    <% for (Transacao t : lancamentos) { %>
                        <tr class="align-middle">
                            ...
                            <td class="text-end">
                                ...
                                <%-- MODIFICAÇÃO AQUI --%>
                                <% } else { %>
                                    <%-- Para contas recorrentes, adicionamos um link para a página de dashboard --%>
                                    <a href="dashboard.jsp#recorrente-tab" class="btn btn-sm btn-outline-primary" title="Editar conta recorrente no dashboard">
                                        <i class="bi bi-pencil-fill"></i>
                                    </a>
                                <% } %>
                            </td>
