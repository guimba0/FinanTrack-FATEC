...
<%
    ...
    if (gIdParam == null) { response.sendRedirect("meus_grupos.jsp"); return; }
...
<body>
    ...
    <div class="container mt-4 mb-5">
        ...
        <% String msg = (String) session.getAttribute("msgGrupo");
           if(msg != null) { session.removeAttribute("msgGrupo"); %>
           <div class="alert alert-success"><%= msg %></div>
        <% } %>
        <% String err = (String) session.getAttribute("errGrupo");
           if(err != null) { session.removeAttribute("errGrupo"); %>
